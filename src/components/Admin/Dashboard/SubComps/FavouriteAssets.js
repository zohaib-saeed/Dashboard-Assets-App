...
const FavouriteAssets = () => {
  ...
  return (
    <div
      ref={containerRef}
      className={`w-full gap-5 rounded-2xl p-3 lg:p-5 flex flex-col lg:flex-row items-start lg:items-end justify-start bg-mirage overflow-x-hidden ${
        isDragging ? "grabbing-area" : "grab"
      }`}
